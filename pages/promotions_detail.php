...
<div class="container-fluid py-4 main-promotions-content" style="background:#fff; margin-top: 40px;">
  <div class="row">
    ...
    <div class="container-fluid py-4 introduction-main-bg" style="margin-top: 15px;">
      <div class="row">
        <!-- Sidebar -->
        <div class="col-lg-2 col-md-3 mb-4">
          <div class="card shadow-sm mb-4" style="position: relative; z-index: 100;">
            <div class="card-body p-3" style="position: relative; z-index: 101;">
              <h5 class="sidebar-title mb-3">Categories</h5>
              <ul class="list-group list-group-flush">
                <li class="list-group-item"><a href="/pages/type_products.php" class="text-dark text-decoration-none sidebar-link">All Products</a></li>
                <li class="list-group-item"><a href="/pages/new_products.php" class="text-dark text-decoration-none sidebar-link">New Products</a></li>
                <li class="list-group-item"><a href="/pages/sale_products.php" class="text-dark text-decoration-none sidebar-link">Sale Products</a></li>
                <li class="list-group-item"><a href="/pages/belt_accessories.php" class="text-dark text-decoration-none sidebar-link">Belt Accessories</a></li>
                <li class="list-group-item"><a href="/pages/handbag_accessories.php" class="text-dark text-decoration-none sidebar-link">Handbag Accessories</a></li>
                <li class="list-group-item"><a href="/pages/detail_orders.php" class="text-dark text-decoration-none sidebar-link">Detail Order</a></li>
                <li class="list-group-item"><a href="/pages/introduction.php" class="text-dark text-decoration-none sidebar-link">Introduction</a></li>
                <li class="list-group-item"><a href="/pages/new_promotions.php" class="text-dark text-decoration-none sidebar-link">Promotions</a></li>
              </ul>
            </div>
          </div>
        </div>

    ...
    <footer>
        ...
        <div class="footer-bottom mt-4">
            ...
            <div class="certifications text-end">
                <strong style="margin-right:78px;">Checkout</strong>
                <div class="payment-logos">
                    ...
                    <div class="logo-row">
                        ...
                        <img style="margin-right:52px;" src="https://img.icons8.com/color/48/000000/mastercard.png" height="32" alt="MasterCard">
                    </div>
                </div>
            </div>
        </div>

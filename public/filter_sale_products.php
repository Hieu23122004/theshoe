                    ...
                    <a href="detail_products.php?id=<?php echo $row['product_id']; ?>" class="product-link">
                        <div class="product-image-container" style="position:relative;">
                            ...
                            <?php if ($row['discount_percent'] >= 20): ?>
                                <span style="position:absolute;bottom:8px;right:8px;background:rgba(255,255,255,0.9);color:#e74c3c;font-weight:bold;padding:2px 8px;border-radius:12px;font-size:15px;z-index:2;">
